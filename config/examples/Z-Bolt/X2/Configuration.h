 ...
 * and supports more than 2 printing heads:
...
#define MAGNETIC_TOOLCHANGER
  ...
  // #define MAGNETIC_TOOLCHANGER_X_POS          { 10.8, 166 }  // (mm) X positions for parking the extruders
  #define MAGNETIC_TOOLCHANGER_X_POS          { 10, 70, 120, 160}  // (mm) X positions for parking the extruders
#endif
